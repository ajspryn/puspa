@extends('super-admin.anggota.lihat')
                        ...
                        <div class="card hovercard text-center">
                            ...
                            <div class="user-image">
                                ...
                                <ul class="share-icons">
                                    ...
                                    <li><a class="social-icon bg-secondary" href="#"><i class="fa fa-wechat"></i></a>
                                    </li>
                                ...
                                <div class="default-according style-1 faq-accordion" id="accordionExample">
                                    <div class="card">
                                        <div class="card-header" id="headingOne">
                                            <h2 class="mb-0">
                                                <button class="btn btn-link btn-block text-start ps-0 pe-0" type="button"
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="headingTwo">
                                            <h2 class="mb-0">
                                                <button class="btn btn-link btn-block text-start collapsed ps-0 pe-0"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="timeline-content">
                                                    <p>
                                                        ...
                                                        sed urna in justo euismod condimentum. Fusce
                                                    ...
                                                    <div class="social-chat">
                                                        ...
                                                        <div class="other-msg">
                                                            <div class="media"><img
                                                                ...
                                                                <div class="media-body"><span class="f-w-600">Alexendra
                                                                        Dhadio <span>1 Month Ago <i
                                                                                class="fa fa-reply font-primary"></i></span></span>
                                                                    <p>yes, really very awesome car i see the features of
                                                                        this car in the official website of #Mercedes-Benz
                                                        ...
                                                        <ul class="text-center">
                                                            <li>
                                                                <div class="latest-post"><img class="img-fluid"
                                                                        alt=""
                                                                        src="../assets/images/social-app/post-1.png"></div>
                                                            </li>
                                                            <li>
                                                                <div class="latest-post"><img class="img-fluid"
                                                                        alt=""
                                                                        src="../assets/images/social-app/post-2.png"></div>
                                                            </li>
                                                            <li>
                                                                <div class="latest-post"><img class="img-fluid"
                                                                        alt=""
                                                                        src="../assets/images/social-app/post-3.png"></div>
                                                            </li>
                                                            <li>
                                                                <div class="latest-post"><img class="img-fluid"
                                                                        alt=""
                                                                        src="../assets/images/social-app/post-4.png"></div>
                                                            </li>
                                                            <li>
                                                                <div class="latest-post"><img class="img-fluid"
                                                                        alt=""
                                                                        src="../assets/images/social-app/post-5.png"></div>
                                                            </li>
                                                            <li>
                                                                <div class="latest-post"><img class="img-fluid"
                                                                        alt=""
                                                                        src="../assets/images/social-app/post-6.png"></div>
                                                            </li>
                                                            <li>
                                                                <div class="latest-post"><img class="img-fluid"
                                                                        alt=""
                                                                        src="../assets/images/social-app/post-7.png"></div>
                                                            </li>
                                                            <li>
                                                                <div class="latest-post"><img class="img-fluid"
                                                                        alt=""
                                                                        src="../assets/images/social-app/post-8.png"></div>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row details-about">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="your-details your-details-xs"><span
                                                                ...
                                                                Artists:</span>
                                                            <p>Iron Maid, DC/AC, Megablow, The Ill, Kung Fighters, System of
                                                                a Revenge.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="your-details your-details-xs"><span
                                                            ...
                                                            <p>The Crime of the Century, Egiptian Mythology 101, The Scarred
                                                                Wizard, Lord of the Wings, Amongst Gods, The Oracle, A Tale
                                                                of Air and Water.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row details-about">
                                                    <div class="col-sm-6">
                                                        <div class="your-details"><span
                                                            ...
                                                            <p>Idiocratic, The Scarred Wizard and the Fire Crown, Crime
                                                                Squad Ferrum Man.</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="your-details your-details-xs"><span
                                                            ...
                                                            <p>Martin T. Georgeston, Jhonathan R. Token, Ivana Rowle,
                                                                Alexandr Platt, Marcus Roth.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row details-about">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="row details-about">
                                                    <div class="col-sm-6">
                                                        <div class="your-details"><span class="f-w-600">The New College
                                                                of Design</span>
                                                            <p>2001 - 2006</p>
                                                            <p>Breaking Good, RedDevil, People of Interest, The Running
                                                                Dead, Found, American Guy.</p>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="your-details your-details-xs"><span
                                                            ...
                                                            <p>2006-2008</p>
                                                            <p>Digital Design Intern for the “Multimedz” agency. Was in
                                                                charge of the communication with the clients.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row details-about">
                                            ...
                                            <div class="card-body">
                                                <div class="activity-log">
                                                    <div class="my-activity">
                                                        ...
                                                        <p><span><i class="m-r-20"
                                                                    data-feather="message-square"></i></span>Sarah Loren
                            ...
                            <div class="col-xl-3 xl-100 box-col-12">
                                <div class="default-according style-1 faq-accordion job-accordion" id="accordionoc3">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12 xl-50 box-col-6">
                                            <div class="card"><img class="img-fluid"
                                                    src="../assets/images/social-app/timeline-4.png" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
