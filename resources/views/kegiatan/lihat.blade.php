                                    ...
                                    <div class="card-body">
                                        <div class="ecommerce-widgets media">
                                            <div class="media-body">
                                                ...
                                                <h4 class="f-w-500 mb-0 f-20">1.<span class="counter">Rumusan ide</span></h4>
                                                @elseif ($kegiatan->status_tahapan==2)
                                                <h4 class="f-w-500 mb-0 f-20">2.<span class="counter">Perencanaan</span></h4>
                                                @elseif ($kegiatan->status_tahapan==3)
                                                <h4 class="f-w-500 mb-0 f-20">3.<span class="counter">Persiapan</span></h4>
                                                @elseif ($kegiatan->status_tahapan==4)
                                                <h4 class="f-w-500 mb-0 f-20">4.<span class="counter">Pembangunan</span></h4>
                                                @elseif ($kegiatan->status_tahapan==5)
                                                <h4 class="f-w-500 mb-0 f-20">5.<span class="counter">Penerapan</span></h4>
                                                @elseif ($kegiatan->status_tahapan==6)
                                                <h4 class="f-w-500 mb-0 f-20">6.<span class="counter">Evaluasi</span></h4>
                                                @endif
                                            </div>
                                            <div class="ecommerce-box light-bg-primary"><i aria-hidden="true"> {{ $kegiatan->persentase_progres }} %</i></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="media">
                                            <div class="media-body">
                                                ...
                                                <div class="progress-box">
                                                    <h4 class="f-w-500 mb-0 f-20">{{ $progres }}<span class="counter">%</span></h4>
                                                    <div
                                                        ...
                                                        <div class="progress-gradient-primary" role="progressbar"
                                                            style="width: 35%" aria-valuenow="{{ $progres }}" aria-valuemin="0"
                                                            aria-valuemax="100"><span class="font-primary">{{ $progres }} %</span><span
